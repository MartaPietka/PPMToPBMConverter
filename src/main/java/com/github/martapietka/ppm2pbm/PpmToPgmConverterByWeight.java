...
public class PpmToPgmConverterByWeight extends PpmToPgmConverter {
    ...
    public void printOutput(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        while ((rgbArray = inputStream.readNBytes(3)).length > 0) {
            ...
            PpmConverterStrategy grayscale = new PpmConverterStrategy(new RgbToGrayscaleByWeightConverter());
